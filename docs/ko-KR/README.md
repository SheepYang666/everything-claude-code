...
### v1.10.0 — `feature-workflow` (2026년 4월)

- **🧭 `feature-workflow`** — Codex와 slash 호환 하네스를 위한 재사용 가능한 기능 개발 흐름이 추가되었습니다. `Feature request`, `Current context`, `Constraints`를 순서대로 수집하고, 구현 전에 계획을 세우며, 마지막은 리뷰와 검증으로 닫습니다.
