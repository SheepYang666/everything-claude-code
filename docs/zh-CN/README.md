...
如果你已经在 **Codex** 里装好了 ECC，直接看这份按真实工作流组织的中文手册：
[Codex 下使用 ECC 的开发场景手册](./CODEX-ECC-DEVELOPMENT-SCENARIOS.md)
...
| 角色 | 目的 |
|------|---------|
| `ecc_explorer` | 在进行编辑前进行只读的代码库证据收集 |
| `ecc_reviewer` | 正确性、安全性和缺失测试的审查 |
| `ecc_docs_researcher` | 在发布/文档更改前进行文档和 API 验证 |
